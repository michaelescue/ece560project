...
cp -f /u/mescue/darkriscv/Output_Results/qcache/AN/modelsim.ini .

# $vlib_exec /u/mescue/darkriscv/./work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini work /u/mescue/darkriscv/./work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /u/mescue/darkriscv/./work')"
endif
...
# endif
# $vlib_exec /u/mescue/darkriscv/.//Output_Results/qcache/AN/zin_vopt_work
if($status == 0) then
  $vmap_exec -modelsimini modelsim.ini z0in_work_ctrl /u/mescue/darkriscv/.//Output_Results/qcache/AN/zin_vopt_work
else
  echo "** Error: Library mapping failed. (Command: 'vlib /u/mescue/darkriscv/.//Output_Results/qcache/AN/zin_vopt_work')"
endif
